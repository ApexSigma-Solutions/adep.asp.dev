...
class Settings(BaseSettings):
    ...
    NEO4J_AUTH: str = Field(
        "neo4j/apexsigma_neo4j_password", description="Neo4j authentication"
    )
    ...
    LANGFUSE_HOST: str = Field(
        "https://cloud.langfuse.com", description="Langfuse host"
    )
    ...
    SERPER_API_KEY: Optional[str] = Field(
        None, description="Serper API key for web search"
    )
    ...
    COMPOSE_PROJECT_NAME: str = Field(
        "apexsigma", description="Docker Compose project name"
    )
