...
A merge queue's purpose is to give you the guarantee of all code being tested against `main` without needing to do that work serially or in reaction to code merging into main. The merge queue service predicts the future state of `main` and tests against that. ([see predictive testing](https://docs.trunk.io/merge-queue/concepts-and-optimizations/predictive-testing)). Returning to our example - pull requests A and B would both be submitted to the merge queue, which would then perform the predictive testing to ensure that A and B, when combined, do not break the build.

### **What is unique about Trunk Merge Queue?**

<table data-view="cards"><thead><tr><th align="center"></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td align="center">Batching</td><td><a href="concepts-and-optimizations/batching">batching</a></td></tr><tr><td align="center">Dynamic Parallel Queues</td><td><a href="concepts-and-optimizations/parallel-queues">parallel-queues</a></td></tr><tr><td align="center">Optimistic Merging</td><td><a href="concepts-and-optimizations/optimistic-merging">optimistic-merging</a></td></tr><tr><td align="center">Pending Failure Depth</td><td><a href="concepts-and-optimizations/pending-failure-depth">pending-failure-depth</a></td></tr><tr><td align="center">Prioritization</td><td><a href="pr-prioritization">pr-prioritization</a></td></tr><tr><td align="center">Flaky Test Protection</td><td><a href="concepts-and-optimizations/anti-flake-protection">anti-flake-protection</a></td></tr></tbody></table>
