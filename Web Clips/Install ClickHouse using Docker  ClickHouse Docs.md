---
title: "Install ClickHouse using Docker | ClickHouse Docs"
source: "https://clickhouse.com/docs/install/docker"
author:
published:
created: 2025-10-01
...
**Author:** 
**Published:** 
**Source:** [Install ClickHouse using Docker | ClickHouse Docs](https://clickhouse.com/docs/install/docker)
**Status:** #unprocessed
**tags:** 
 
## Content

The guide on [Docker Hub](https://hub.docker.com/r/clickhouse/clickhouse-server/) is reproduced below for convenience. The Docker images available make use of the official ClickHouse deb packages.
...
- Since ClickHouse 24.11 Ubuntu images began using `ubuntu:22.04` as its base image. It requires docker version >= `20.10.10` containing [patch](https://github.com/moby/moby/commit/977283509f75303bc6612665a04abf76ff1d2468). As a workaround you could use `docker run --security-opt seccomp=unconfined` instead, however this has security implications.
...
See [ClickHouse client](https://clickhouse.com/docs/interfaces/cli) for more information about ClickHouse client.
...
See [ClickHouse HTTP Interface](https://clickhouse.com/docs/interfaces/http) for more information about the HTTP interface.
...
For more information see ["Configuring CAP\_IPC\_LOCK and CAP\_SYS\_NICE Capabilities in Docker"](https://clickhouse.com/docs/knowledgebase/configure_cap_ipc_lock_and_cap_sys_nice_in_docker)
